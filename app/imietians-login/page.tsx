import { ImietiansLoginForm } from "@/components/imietians-login-form"
import { Logo } from "@/components/logo"
import { MobileMenu } from "@/components/mobile-menu"
import Link from "next/link"
import { Button } from "@/components/ui/button"

export default function ImietiansLoginPage() {
  return (
        ...
        <div className="container max-w-md mx-auto py-12 px-4">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            <div className="bg-primary p-6 text-white text-center">
              <h1 className="text-2xl font-bold">Imietians Portal</h1>
              <p className="text-white/80 mt-2">Access your talent dashboard</p>
            </div>
            <div className="p-6">
              <ImietiansLoginForm />
            </div>
